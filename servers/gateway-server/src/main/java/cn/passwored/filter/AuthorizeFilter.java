package cn.passwored.filter;

import cn.hutool.core.util.CharsetUtil;
import cn.hutool.crypto.SmUtil;
import cn.hutool.crypto.symmetric.SymmetricCrypto;
import cn.passwored.bean.ApiResponse;
import cn.passwored.bean.ApiStatus;
import cn.passwored.bean.TokenAuthenticationException;
import cn.passwored.util.jwt.JWTUtil;
...
public class AuthorizeFilter implements GlobalFilter, Ordered {
    ...
    //认证路径
    public static final String LOGIN_USER_URL = "/apiUser/admin/login";
    @Override
